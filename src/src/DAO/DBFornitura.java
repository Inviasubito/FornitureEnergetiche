...
public class DBFornitura {
	...
	public DBContatore getContatore() {
		return contatore;
	}
	public void setContatore(DBContatore contatore) {
		this.contatore = contatore;
	}
	public ArrayList<DBFattura> getFatture() {
		return fatture;
	}
	public void setFatture(ArrayList<DBFattura> fatture) {
